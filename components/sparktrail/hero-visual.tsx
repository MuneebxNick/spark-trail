...
export function SocialProofChip({ className }: { className?: string }) {
  return (
    <div
      className={`inline-flex items-center gap-3 rounded-full border border-[#111111]/[0.06] bg-white px-4 py-2.5 shadow-[0_4px_16px_-4px_rgba(17,17,17,0.06)] ${className ?? ''}`}
    >
      ...
      */}
      <div className="relative flex flex-col gap-6 py-4">
        ...
        <motion.div 
          ...
          className="absolute left-[17px] top-8 bottom-8 w-[2px] origin-top bg-[#111111]/[0.06] hidden sm:block"
        />
        ...
        <motion.div {...entranceProps(0.3)} className="relative flex items-start sm:gap-6">
          ...
          <div className="hidden sm:flex mt-6 w-[36px] justify-center z-10 shrink-0">
            <div className="h-2.5 w-2.5 rounded-full bg-[#7857FF] shadow-[0_0_0_4px_#F6F5EF]" />
          </div>
          {/* Card */}
        ...
        <motion.div {...entranceProps(0.4)} className="relative flex items-start sm:gap-6">
          ...
          <div className="hidden sm:flex mt-12 w-[36px] justify-center z-10 shrink-0">
            <div className="h-2.5 w-2.5 rounded-full bg-[#C7FF3D] shadow-[0_0_0_4px_#F6F5EF]" />
          </div>
          {/* Card */}
